...
Time-stamp: <2005-05-11 01:03:01 tfuruka1>
$Id: readme.txt,v 1.15 2005/05/10 16:05:06 tfuruka1 Exp $
$Name:  $


       テキストファイル印刷ツール「ak2ps のようなもの」 Ver. 2.5
                    ～とっても不親切なマニュアル～
...
==========
  ...
  ★ Ver. 2.5 (MATSUO-HACHIMANTAI) 2005/05/11
     ...
     ・ メール印刷したときに, ヘッダの 2 行目以降が文字化けする問題を
        ...
        ていましたが, モノクロ印刷の時の対応が不十分でした(茅野様の修
        正をそのまま適用させて頂きました)。
