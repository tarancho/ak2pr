...
Time-stamp: <2003-02-26 21:36:57 tfuruka1>


       テキストファイル印刷ツール「ak2psのようなもの」Ver. 2.0
                    ～とっても不親切なマニュアル～
...
では多分、動作すると思います。因みに私の環境は、Windows NT 4.0です。
...
==========
    ...
    ====================
        ...
        このタブは、現在、全く機能していません。そのうち対応する予定で
        す。
...
ak2prW.exekから自動起動できるように作成していますが、上手く起動できな
い場合があります）。
...
・ Distillerの自動起動(2002/4/22)
　 PostScriptでDistillerの監視フォルダにファイルを作成した後に
   Distiller が起動していない場合は、自動起動するようにする。
...
●このドキュメントの更新履歴
============================
$Id: readme.txt,v 1.1 2003/02/26 12:36:58 tfuruka1 Exp $
$Log: readme.txt,v $
